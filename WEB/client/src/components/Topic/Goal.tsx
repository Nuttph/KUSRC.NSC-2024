    ...
    <div className="bg-[#17191C] text-[#000] flex flex-col">
      ...
      <Reveal>
        <div className="flex items-center justify-center flex-row text-[25px] gap-[20px] px-[50px]">
          <Slide className="bg-[#fff] border-2 border-[#6D6D6D] w-[70%] px-[25px] py-[35px] rounded-xl">
            <div className="">
          ...
          <div className="flex flex-col gap-[20px]">
            <Slide>
              <div className="bg-[#fff] border-2 border-[#6D6D6D] w-[100%] px-[25px] py-[13px] rounded-full">
                เสริมคุณภาพชีวิตโดยรวมด้วยการเพิ่มพลังงานและความสมดุลในชีวิตประจำวัน
              </div>
            </Slide>
            <Slide>
              <div className="flex flex-row gap-[20px]">
                <div className="bg-[#fff] border-2 border-[#6D6D6D] w-[565px] px-[25px] py-[14px] rounded-full">
          ...
          <Slide className="bg-[#ffff] border-2 border-[#6D6D6D] w-[50%] px-[25px] py-[35px] rounded-xl">
            <div className="">
